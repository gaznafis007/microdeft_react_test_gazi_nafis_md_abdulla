    ...
    return (
        <section className="mt-8 md:mt-12 mx-6 md:mx-16">
            <div className="flex flex-col md:flex-row space-x-0 md:space-x-4 space-y-4 md:space-y-0">
                ...
                <form onSubmit={handleSubmit(handleLogin)} className="w-full md:w-1/2 px-4 py-2">
                    ...
                    <Link to='/register' className="font-thin text-slate-800 hover:underline">New here? please register</Link>
